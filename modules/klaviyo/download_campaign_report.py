...
class CAMPAIGN:
    ...
    def download_last_month_report(self) : 
        ...
        new_file_path_last_month = os.path.join(self.local_file_path,f"campaign_{last_month}.csv")
    ...
    def download_current_month_report(self) :
        ...
        new_file_path_curr_month = os.path.join(self.local_file_path,f"campaign_{formatted_date}.csv")
